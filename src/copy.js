...
export const COPY = {
  es: {
    ...
    statementSig: "— Estructuras del Pacífico",
    ...
    contactMeta: ["contacto@estructurasdelpacifico.com", "Oceano Pacífico · MX"],
    footerNote: "Estructuras del Pacífico · Arquitectura tropical en madera · Oceano Pacífico · MX",
  ...
  en: {
    ...
    contactEmail: "contacto@estructurasdelpacifico.com",
    contactMeta: ["contacto@estructurasdelpacifico.com", "Oceano Pacífico · MX"],
    footerNote: "Estructuras del Pacífico · Tropical timber architecture · Oceano Pacífico · MX",
